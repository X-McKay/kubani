...
class TestCriticAgent:
    ...
    def test_execution_analysis_dataclass(self):
        ...
        from core_agents.learning.voyager.critic import CriticVerdict, ExecutionAnalysis
    ...
    def test_skill_review_dataclass(self):
        ...
        from core_agents.learning.voyager.critic import CriticVerdict, SkillProposal, SkillReview
