...
- [ ] **Nodes endpoint** (`/api/cluster/nodes`)
  ...
  - Consider using: `cluster_manager/` Python code or direct K8s API
...
**Backend Options:**
1. Create a new API service in `cluster_manager/` that wraps the Kubernetes Python client
2. Use the existing TUI code as reference: `cluster_manager/tui/app.py`
