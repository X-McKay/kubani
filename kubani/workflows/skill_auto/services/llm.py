"""LLM service layer with dependency injection.

This module provides LLM-related services that accept a client implementation
through dependency injection, enabling easy testing with mock clients.
"""
...
# =============================================================================
# LLM Service with Dependency Injection
# =============================================================================


class LLMService:
    """
    LLM service using dependency injection.

    This service accepts an LLMClient implementation in its constructor,
    making it easy to test with mock clients.
    """
    ...
    def __init__(self, client: LLMClient):
        ...
        Args:
            client: An implementation of the LLMClient protocol.
        """
        self._client = client
...
async def detect_overlap_compat(
    llm_service: LLMService, description: str, existing_skills: list[dict[str, Any]]
) -> OverlapResult:
    """Convert OverlapAnalysis to OverlapResult for backward compatibility."""
    analysis = await llm_service.detect_overlap(description, existing_skills)
