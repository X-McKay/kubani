"""
Unified Configuration Management for Kubani.
...
class MCPServerConfig(BaseSettings):
    ...
    # Skills MCP (new for kubani restructuring)
    skills_url: str = Field(
        default="http://localhost:8086",
        description="Skills MCP server URL",
    )
...
class FeatureFlags(BaseSettings):
    ...
    skills_mcp: bool = Field(
        default=True,
        description="Use Skills MCP server for skill execution",
    )
